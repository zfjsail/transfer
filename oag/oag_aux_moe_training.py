...
def train_epoch(iter_cnt, encoders, classifiers, critic, mats, data_loaders, args, optim_model, task_paras):
    map(lambda m: m.train(), [encoders, critic] + classifiers)
...
def train(args):
    ...
    if args.cuda:
        map(lambda m: m.cuda(), [encoders, critic] + classifiers)
...
if __name__ == '__main__':
    ...
    argparser.add_argument("--train", type=str, default="venue,author,paper,aff",
